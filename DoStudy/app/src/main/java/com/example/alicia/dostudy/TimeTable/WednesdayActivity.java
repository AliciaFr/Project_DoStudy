...
public class WednesdayActivity extends AppCompatActivity {
    ...
    private void initDB() {
        database = new CourseItemDatabase(this, "wednesdayCourses.db");
        database.open();
    }
    ...
    private void initSpinner(){
        ArrayAdapter<CharSequence> spinnerAdapter = ArrayAdapter.createFromResource(WednesdayActivity.this, R.array.colourArray, android.R.layout.simple_spinner_item);
    ...
    private void setupListView() {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent getDetails = new Intent(WednesdayActivity.this, CourseDetailActivity.class);
