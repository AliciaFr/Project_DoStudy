...
public class ThursdayActivity extends AppCompatActivity {
    ...
    private void initSpinner(){
        ArrayAdapter<CharSequence> spinnerAdapter = ArrayAdapter.createFromResource(ThursdayActivity.this, R.array.colourArray, android.R.layout.simple_spinner_item);
    ...
    private void setupListView() {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent getDetails = new Intent(ThursdayActivity.this, CourseDetailActivity.class);
    ...
    private void makeToast(){
        ...
        Toast toast = Toast.makeText(ThursdayActivity.this, deleted, duration);
        toast.show();
    }
